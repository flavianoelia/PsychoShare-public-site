...
function getValidationMessage() {
  ...
  if (!validateName(nameValue))
    return "El nombre debe tener entre 2 y 30 caracteres y solo letras";

  if (!lastnameValue) return "Por favor ingresá tu apellido";
  if (!validateLastName(lastnameValue))
    return "El apellido debe tener entre 2 y 30 caracteres y solo letras";
  ...
  if (!termsCheckbox.checked)
    return "Debés aceptar los Términos y Condiciones para continuar";
